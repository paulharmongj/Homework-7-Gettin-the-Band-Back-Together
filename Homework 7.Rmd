...
for(i in 1:num.sims) {
  ar[,2]<-arima.sim(n=109,model=list(ar=c(.6)),sd=summary(sd=sqrt(0.0006664659)))
  ma[,2]<-arima.sim(n=109,model=list(ar=c(.6)),sd=summary(sd=sqrt(0.0006664659)))
  model.ma.gls<-gls(noise~index,data=ma,correlation=corARMA(p=0.6,q=1))
