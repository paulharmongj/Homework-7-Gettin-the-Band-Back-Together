...
legend("topleft",fill = c(1:12), c("m1","m2","m3","m4","m5","m6","m7","m8","m9","m10","m11","m12"),ncol=4,bty="n",x.intersp=.1,cex=.7)
```
...
legend("topleft",fill = c("hotpink","red","blue"), c("CO2","Top Fitting Model","GAM"),cex=.8)
```
...
$$Cov(y_t,y_{t-1})= Cov(\frac{x_t + x_{t-1}}{2}, \frac{x_{t-1} + x_{t-2}}{2})=$$ $$\frac{1}{4}Cov(x_t, x_{t-1}) + \frac{1}{4}Cov(x_{t-1}, x_{t-1}) + \frac{1}{4}Cov(x_t, x_{t-2}) + \frac{1}{4}Cov(x_{t-1}, x_{t-2})=$$ 
$$\frac{1}{2} + 1 + 0 + \frac{1}{2}= 2$$
